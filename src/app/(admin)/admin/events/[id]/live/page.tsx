...
/**
 * The live door view — built to be watched on a phone while people come in.
 *
 * Polls rather than holding a socket open: five seconds is well inside the
 * useful resolution of a door queue, and it survives the flaky venue wifi that
 * a persistent connection would not.
 */
export default function LiveDoorPage() {
  ...
  return (
    <AdminSection
      ...
      backLink={{ href: `/admin/events/${eventId}`, label: "← Event" }}
      actions={
