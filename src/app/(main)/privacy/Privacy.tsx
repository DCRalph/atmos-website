      ...
      <section className="relative z-10 py-16 sm:py-24">
        <Container>
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <section>
              <h2 className="mt-8 mb-4 text-2xl font-bold">1. Introduction</h2>
              <p className="leading-relaxed text-gray-700">
                Welcome to ATMOS ("we," "our," or "us"). We are committed to
                ...
                atmos-wlg.com or use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4 leading-relaxed text-gray-700">
                ...
                number, postal address, payment information, and any other
            ...
            <section>
              ...
              <ul className="list-disc space-y-2 pl-6 text-gray-700">
                ...
                <li>
                  To send you newsletters, marketing communications, and event
